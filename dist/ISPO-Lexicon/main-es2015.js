...
let LexiconPageComponent = class LexiconPageComponent {
    ...
    // error = "";
    // success = "";
    constructor(breakpointObserver, searchService // private api: ApiService
    ) {
        this.breakpointObserver = breakpointObserver;
        this.searchService = searchService;
        this.tabletSizeAndAbove = true;
    ...
    getSearchResults() {
        this.searchService.getSearchResults().subscribe((results) => (this.tempDatabaseResults = results), (error) => (this.error = error));
    }
