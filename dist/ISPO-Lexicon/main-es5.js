(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdvancedSearchMenuComponent = /** @class */ (function () {
                function AdvancedSearchMenuComponent(breakpointObserver, searchService) {
                ...
                AdvancedSearchMenuComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getTargetValue();
                    ...
                    this.breakpointObserver
                        ...
                        if (state.matches) {
                            _this.tabletSizeAndAbove = false;
                            // Translate toggle only in advanced search when in tablet view and smaller
                            _this.translateOn = _this.searchService.translate;
                            _this.isoStandardOnlyOn = _this.searchService.isoStandardOnly;
                        }
                        else {
                            _this.tabletSizeAndAbove = true;
                        }
                    });
                };
                AdvancedSearchMenuComponent.prototype.ngDoCheck = function () {
                    this.getTargetValue();
                };
                AdvancedSearchMenuComponent.prototype.getTargetValue = function () {
                    this.targets = this.searchService.getSearchTargetValues();
                };
                AdvancedSearchMenuComponent.prototype.toggleTranslate = function (matSlideToggleChange) {
                ...
                AdvancedSearchMenuComponent.prototype.targetSelected = function (event) {
                    console.log(event.value);
                    this.searchService.searchTarget = event.value;
                };
                AdvancedSearchMenuComponent.prototype.onAnimationEventDone = function (event) {
                ...
                return AdvancedSearchMenuComponent;
            }());
            AdvancedSearchMenuComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LanguageBarComponent = /** @class */ (function () {
                function LanguageBarComponent(searchService) {
                    this.searchService = searchService;
                    this.languages = [
                ...
                LanguageBarComponent.prototype.getTranslateValue = function () {
                    this.translateOn = this.searchService.translate;
                };
                LanguageBarComponent.prototype.firstLanguageTabDisabled = function (language) {
                ...
                LanguageBarComponent.prototype.firstLanguageClicked = function (language) {
                    this.activeLanguage = language;
                    this.searchService.firstLang = this.activeLanguage;
                };
                LanguageBarComponent.prototype.translatedLanguageClicked = function (language) {
            ...
            LanguageBarComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SearchResultCellComponent = /** @class */ (function () {
                function SearchResultCellComponent() {
                    this.isoStandard = false; // if no input, default value is fale
                }
                SearchResultCellComponent.prototype.ngOnInit = function () { };
                return SearchResultCellComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchResultRowComponent = /** @class */ (function () {
                function SearchResultRowComponent(breakpointObserver, searchService) {
                    this.breakpointObserver = breakpointObserver;
                    this.searchService = searchService;
                ...
                SearchResultRowComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                SearchResultRowComponent.prototype.ngDoCheck = function () {
                    this.getTranslateValue();
                };
                SearchResultRowComponent.prototype.getTranslateValue = function () {
                    this.translateOn = this.searchService.translate;
                };
                return SearchResultRowComponent;
            }());
            SearchResultRowComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var AcknowledgementPageComponent = /** @class */ (function () {
                function AcknowledgementPageComponent() {
                ...
                AcknowledgementPageComponent.prototype.ngOnInit = function () { };
                return AcknowledgementPageComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                ...
                HeaderComponent.prototype.navigateToLexicon = function () {
                    this.buttonClicked.emit(1);
                    this.buttonSelected = 1;
                };
                HeaderComponent.prototype.navigateToAcknowledgement = function () {
                    this.buttonClicked.emit(2);
                    this.buttonSelected = 2;
                };
                // TODO add a method in for the language selector
                HeaderComponent.prototype.changeWebsiteLanguage = function (language) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LexiconPageComponent = /** @class */ (function () {
                ...
                LexiconPageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    // Changes the view if the size is tablet and above
                    this.breakpointObserver
                        .observe(["(max-width: 768px)"])
                ...
                LexiconPageComponent.prototype.getTable = function () {
                    ...
                    this.searchService
                        .getResults()
                        .subscribe(function (searchResults) { return (_this.searchResults = searchResults); });
                };
                LexiconPageComponent.prototype.toggleTranslate = function (matSlideToggleChange) {
                    this.translateOn = matSlideToggleChange.checked.valueOf();
                    this.searchService.translate = this.translateOn;
                };
                ...
                LexiconPageComponent.prototype.advancedSearchClosed = function (event) {
                    this.advancedSearchClosedAnimationComplete = event;
                };
                LexiconPageComponent.prototype.advancedSearchOpen = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchService = /** @class */ (function () {
                ...
                Object.defineProperty(SearchService.prototype, "secondLang", {
                    get: function () {
                ...
                Object.defineProperty(SearchService.prototype, "translate", {
                    get: function () {
                ...
                Object.defineProperty(SearchService.prototype, "isoStandardOnly", {
                    get: function () {
                        return this.isoStandardOnlyOn;
                    },
                    set: function (isoStandardOnly) {
                        this.isoStandardOnlyOn = isoStandardOnly;
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(SearchService.prototype, "searchCriteria", {
                    get: function () {
                ...
                Object.defineProperty(SearchService.prototype, "searchTarget", {
                    get: function () {
                        return this.target;
                    },
                    set: function (searchTarget) {
